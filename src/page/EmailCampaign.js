        ...
        <div className="relative overflow-hidden">
            <div className="relative h-[100vh] mx-4 text-color2 overflow-hidden">
                ...
                <main className={`absolute flex gap-0 sm:gap-3  sm:w-full w-[200%] top-14 bottom-16 md:bottom-4 ${isView ? 'left-[-100%]' : 'left-0'} sm:left-0`}>
                    <div className="sm:w-[300px] w-1/2 mr-3 p-3 bg-secondary rounded-md overflow-auto">
                        <EmailMenu campaign={campaign} selectedCampaign={selectedCampaign} setCampaign={setCampaign} isEdit={isEdit} />
                    </div>
                    <div className="flex flex-col sm:grow w-1/2 ml-3 p-3 bg-secondary rounded-md overflow-auto">
                        <div className="grow">
